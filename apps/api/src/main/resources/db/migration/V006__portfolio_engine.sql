-- ============================================================================
-- Phase 10 — Portfolio Builder Engine Schema
-- ============================================================================
...
-- Singleton section type constraints per portfolio
CREATE UNIQUE INDEX uq_single_hero ON portfolio_sections(portfolio_id) WHERE section_type = 'HERO';
CREATE UNIQUE INDEX uq_single_about ON portfolio_sections(portfolio_id) WHERE section_type = 'ABOUT';
CREATE UNIQUE INDEX uq_single_services ON portfolio_sections(portfolio_id) WHERE section_type = 'SERVICES';
CREATE UNIQUE INDEX uq_single_service_areas ON portfolio_sections(portfolio_id) WHERE section_type = 'SERVICE_AREAS';
CREATE UNIQUE INDEX uq_single_contact ON portfolio_sections(portfolio_id) WHERE section_type = 'CONTACT';
CREATE UNIQUE INDEX uq_single_cta ON portfolio_sections(portfolio_id) WHERE section_type = 'CTA';
