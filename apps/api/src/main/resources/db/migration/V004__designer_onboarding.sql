-- ============================================================================
-- Phase 08 — Professional / Studio Onboarding Schema
-- ============================================================================
...
ALTER TABLE designer_studios
    ...
    ADD COLUMN experience_since_year smallint NULL CHECK (experience_since_year IS NULL OR (experience_since_year >= 1900 AND experience_since_year <= 2100)),
    ADD COLUMN team_size text NULL,
    ADD COLUMN budget_range text NULL,
...
CREATE UNIQUE INDEX uq_studio_current_slug ON studio_slug_claims(studio_id) WHERE state = 'CURRENT';
