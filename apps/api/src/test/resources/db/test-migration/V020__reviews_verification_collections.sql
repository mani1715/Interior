-- ============================================================================
-- Phase 27 — Reviews + Verification + Collections Schema (H2 Compatibility)
-- ============================================================================
...
-- 1.2 Review Invitation Scoped Sessions
...
CREATE INDEX idx_studio_reviews_project ON studio_reviews (project_id);
...
-- 2.2 Studio Verification Documents
...
-- 2.3 Studio Verification Events
