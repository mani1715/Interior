...
| Backend | Spring Boot **4.1.1**, Spring MVC/Security/JDBC | [System requirements](https://docs.spring.io/spring-boot/system-requirements.html) cover Java25. Use Boot BOM for managed dependencies, not independent framework pins |
